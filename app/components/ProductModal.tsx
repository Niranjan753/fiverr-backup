      ...
      <Dialog as="div" className="relative z-50" onClose={onClose}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="w-full max-w-2xl transform overflow-hidden rounded-2xl bg-black border border-yellow-400/20 p-6 text-left align-middle shadow-xl transition-all">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  {/* Content */}
                  <div>
                    <Dialog.Title as="h3" className="text-2xl font-bold text-yellow-400 mb-2">
                      {product.name}
                    </Dialog.Title>

                    <div className="flex items-baseline space-x-2 mb-4">
                      <span className="text-2xl font-bold text-yellow-400">₹{discountedPrice}</span>
                      {product.discount > 0 && (
                    ...
                    <div className="mt-6 flex gap-4">
                      ...
                      <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        onClick={onClose}
                        className="px-4 py-2 rounded-lg font-medium border border-yellow-400/50 text-yellow-400 hover:bg-yellow-400/10 transition-colors"
                      >
                        Close
                      </motion.button>
                    </div>
