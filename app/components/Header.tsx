          ...
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-center">
              ...
              <div className="flex justify-center space-x-8">
                ...
                <Link href="/products" className="py-2 text-sm hover:text-yellow-300 transition-colors">Products</Link>
                ...
                <Link href="/kids-special" className="py-2 text-sm hover:text-yellow-300 transition-colors border-b-2 border-transparent hover:border-yellow-300">Kids Special</Link>
                <Link href="/vanitha-series" className="py-2 text-sm hover:text-yellow-300 transition-colors border-b-2 border-transparent hover:border-yellow-300">Vanitha Series</Link>
              </div>
            </div>
          </div>
        </nav>
